...
const CONFIG = {
    ...
    loveMessages: {
        extreme: "ваааау ты обожаешь меня настолько??? 🥰🚀💝",  // Shows when they go past 5000%
    ...
    music: {
        ...
        musicUrl: "cameron-winter-love-takes-miles-mp3pm_gIbvgFyR.mp3", // Music streaming URL
